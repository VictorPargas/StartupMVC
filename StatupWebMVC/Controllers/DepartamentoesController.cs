...
namespace StatupWebMVC.Controllers
{
    public class DepartamentoesController : Controller
    {
        private readonly StatupWebMVCContext _context;

        public DepartamentoesController(StatupWebMVCContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Departamento != null ? 
                          ...
                          Problem("Entity set 'StatupWebMVCContext.Departamento'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'StatupWebMVCContext.Departamento'  is null.");
            }
            var departamento = await _context.Departamento.FindAsync(id);
            if (departamento != null)
            {
